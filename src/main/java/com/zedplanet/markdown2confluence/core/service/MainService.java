...
import static com.zedplanet.markdown2confluence.core.ConfluenceConfig.DEFAULT_PARSE_TIMEOUT;
...
public class MainService {
    ...
    public void processAll(ConfluenceConfig confluenceConfig) throws IOException {
        ...
        for (Page page : orderedList) {
            ...
            wikiText = processInlineImages(markdownText, wikiText, Paths.get(page.getFilepath()).toFile(), imageURIToFilePathMap);
