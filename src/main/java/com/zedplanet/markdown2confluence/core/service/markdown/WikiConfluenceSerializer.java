package com.zedplanet.markdown2confluence.core.service.markdown;
    ...
    */
    protected class SpecialPanelProcessor {
        ...
        boolean apply( BlockQuoteNode bqn ) {
            ...
            List<Node> children = bqn.getChildren();
    ...
    public void visit(OrderedListNode oln) {
        ...
        try {
            ...
            for (Node child : oln.getChildren()) {
                _buffer.append( "#".repeat(listLevel) ).append(' ');
                child.accept(this);
                _buffer.append('\n');
            }
            _buffer.append('\n');
